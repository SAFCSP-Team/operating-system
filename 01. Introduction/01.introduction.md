...
1. Top-Down: Provide simple APIs for software to use. 
2. Button-up: Manages resources and schedules their usage.

[Image of the computer system structure with 2 arrows. one representing top-down, and the other representing bottom-up]
