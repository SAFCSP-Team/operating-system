...
Once your computer is running, you are free to run any program you like.
To be covered:
...
<!-- First it starts with the start/boot of the computer, then it does its job by managing the operation of the computer, then it ends with shutting down the computer -->
...
Now, before jumping to the operating system perspective, what do you think will happen if you stuffed two or more software in the hardware?
