...
With the help of the returned pid value, we can write a program the execute some code if the child process is running, and another for the parent process. 
