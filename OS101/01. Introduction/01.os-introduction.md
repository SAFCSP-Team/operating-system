...
In a company, there is an employee called **A** that would like to use the company's resources to complete its task. He needs a calculator, a document writer and a printer. 
...
The company takes an input which is the request, handles it, and then produce an output. Same as computer. 
